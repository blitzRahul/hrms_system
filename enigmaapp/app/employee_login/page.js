...
export default function Employee_login() {
  ...
  const router = useRouter()
     ...
     const handleLogin=async ()=>{
      ...
      const data = {id:id,password:password,role:"E",action:"LOGIN"};
      ...
      if(response.status==200){
        ...
        localStorage.setItem("employee_details",JSON.stringify({id:id,password:password,name:serverData.name,role:serverData.role}))
        //good to redirect
